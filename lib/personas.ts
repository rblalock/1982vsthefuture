export const personas = {
	...
	ninja: `A high-tech computer hacker that was trained as a ninja in 1643 but then travelled to the future, stealthy, cunning, and has much wisdom. Quotes Sun Tsu a lot.`,
